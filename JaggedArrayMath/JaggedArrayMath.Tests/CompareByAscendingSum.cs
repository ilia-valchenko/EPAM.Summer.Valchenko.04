...
{
    /// <summary>
    /// This class represents criterion for ascending sorting two-dimensional array by sum of elements of each row.
    /// </summary>
    public class CompareByAscendingSum : IComparer<int[]>
    {
        /// <summary>
