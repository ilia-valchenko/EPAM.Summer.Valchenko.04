...
{
    /// <summary>
    /// This class represents criterion for descending sorting two-dimensional array by Min element of each row.
    /// </summary>
    class CompareByDescendingMinElement : IComparer<int[]>
    {
        /// <summary>
        ...
        /// <returns>Returns 0 if min of arrays element are equal. Returns -1 if sum of element of the first elements more than another one.</returns>
